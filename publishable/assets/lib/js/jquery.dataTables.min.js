...
oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Следующая",sPrevious:"Предыдушая"},sEmptyTable:"No data available in table",sInfo:"Показано с _START_ до _END_ из _TOTAL_ записей",sInfoEmpty:"Показано 0 из 0 of 0 записей",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показывать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
